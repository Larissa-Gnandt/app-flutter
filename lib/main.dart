  ...
  Widget build(BuildContext context) {
    ...
    Widget textSection = Container(
      ...
      child: const Text(
        ...
        'teleférico a partir de Kandersteg, seguido por meia hora de caminhada por pastagens '
        'e floresta de pinheiros, leva você ao lago, que aquece até 20 graus Celsius no verão. '
